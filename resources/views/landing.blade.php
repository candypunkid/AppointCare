...
<head>
  ...
  <title>{{ $brandName }} — Smart Appointment Management</title>
...
{{ $cssVars }}
    ...
    h1,h2,h3,h4,h5,h6 { font-family: var(--font-family, 'Inter', sans-serif); line-height: 1.1; letter-spacing: -0.02em; }
    ...
    .logo-icon img { width: 22px; height: 22px; border-radius: 4px; object-fit: contain; }
    .logo span { font-family: var(--font-family, 'Inter', sans-serif); font-weight: 700; font-size: 17px; }
    ...
    .btn-nav-ghost {
      padding: 8px 20px; border-radius: 8px;
      border: 1px solid var(--border-color); color: var(--muted);
      font-size: 13px; transition: all .2s;
    }
    .btn-nav-ghost:hover { border-color: var(--primary); color: var(--white); }

    .hero { position: relative; overflow: hidden; padding: 100px 0 80px; }
    .hero .blob-1 { width: 600px; height: 600px; background: rgba(91,141,239,0.12); top: -200px; left: -100px; }
    .hero .blob-2 { width: 500px; height: 500px; background: rgba(139,92,246,0.1); bottom: -200px; right: -80px; }
    .hero-inner { max-width: 1200px; margin: 0 auto; padding: 0 32px; display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center; position: relative; z-index: 1; }
    .hero-badge {
      display: inline-flex; align-items: center; gap: 8px;
      padding: 8px 16px; border-radius: 100px;
      border: 1px solid var(--primary); opacity: 0.35;
      background: var(--primary); opacity: 0.07;
      font-size: 13px; color: var(--primary);
      margin-bottom: 20px;
      font-family: var(--font-family, 'Inter', sans-serif); font-weight: 600; letter-spacing: .5px;
    }
    .hero-badge span { width: 6px; height: 6px; border-radius: 50%; background: var(--secondary); display:block; }
    h1.hero-title {
    ...
    .hero-sub { color: var(--muted); font-size: 16px; margin-bottom: 36px; max-width: 460px; }
    ...
    .btn-secondary {
      padding: 15px 32px; border-radius: 14px;
      border: 1px solid var(--border-color); color: var(--muted); font-size: 14px;
      transition: all .2s; background: rgba(255,255,255,0.03);
    }
    .btn-secondary:hover { border-color: var(--primary); color: var(--white); background: rgba(255,255,255,0.06); }

    .trusted-row { margin-top: 48px; display: flex; align-items: center; gap: 16px; color: var(--muted); font-size: 13px; }
    ...
    .appt-item { display: flex; align-items: center; gap: 14px; padding: 14px; border-radius: 12px; background: var(--bg2); margin-bottom: 12px; }
    .appt-avatar { width: 40px; height: 40px; border-radius: 12px; display: grid; place-items: center; font-size: 18px; flex-shrink: 0; }
    .appt-info { flex: 1; }
    .appt-name { font-family: var(--font-family, 'Inter', sans-serif); font-weight: 600; font-size: 14px; color: var(--white); }
    .appt-meta { font-size: 12px; color: var(--muted); }
    .appt-badge { font-size: 11px; padding: 4px 10px; border-radius: 20px; font-weight: 600; }
    ...
    .stat-box { background: rgba(2, 6, 23, 0.4); border-radius: 12px; padding: 14px; text-align: center; }
    .stat-num { font-family: var(--font-family, 'Inter', sans-serif); font-weight: 800; font-size: 22px; color: var(--white); }
    .stat-lbl { font-size: 11px; color: var(--muted); margin-top: 2px; }

    section { position: relative; }
    .section-inner { max-width: 1200px; margin: 0 auto; padding: 0 32px; }
    .section-head { text-align: center; margin-bottom: 72px; }
    .overline { font-size: 13px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: var(--primary); margin-bottom: 10px; font-family: var(--font-family, 'Inter', sans-serif); }
    .section-title { font-size: clamp(32px,4vw,48px); font-weight: 800; color: var(--white); margin-bottom: 16px; letter-spacing: -0.03em; }
    .section-sub { color: var(--muted); max-width: 580px; margin: 0 auto; font-size: 17px; opacity: 0.8; }

    .stats-band { padding: 60px 0; border-top: 1px solid var(--border-color); background: var(--bg2); }
    .stats-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 20px; }
    .stat-card { text-align: center; padding: 28px 20px; }
    .stat-card .num { font-family: var(--font-family, 'Inter', sans-serif); font-size: 40px; font-weight: 800; color: var(--white); }
    .stat-card .num span { background: linear-gradient(135deg,var(--primary),var(--secondary)); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
    ...
    .feat-card:hover { transform: translateY(-6px); border-color: var(--primary); opacity: 0.4; }
    .feat-icon { width: 48px; height: 48px; border-radius: 14px; background: linear-gradient(135deg, var(--primary), transparent); display: grid; place-items: center; margin-bottom: 18px; font-size: 22px; }
    .feat-title { font-family: var(--font-family, 'Inter', sans-serif); font-size: 15px; font-weight: 700; color: var(--white); margin-bottom: 8px; }
    .feat-desc { font-size: 13px; color: var(--muted); line-height: 1.6; }

    .how { padding: 100px 0; background: var(--bg2); }
    .steps-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 28px; }
    .step-card { background: var(--card-bg); border: 1px solid var(--border-color); backdrop-filter: blur(10px); border-radius: 16px; padding: 36px 28px; text-align: center; }
    .step-num { width: 52px; height: 52px; border-radius: 50%; background: linear-gradient(135deg,var(--primary),var(--secondary)); display: grid; place-items: center; font-family: var(--font-family, 'Inter', sans-serif); font-size: 20px; font-weight: 800; color: var(--white); margin: 0 auto 20px; }
    .step-title { font-family: var(--font-family, 'Inter', sans-serif); font-size: 17px; font-weight: 700; color: var(--white); margin-bottom: 10px; }
    .step-desc { font-size: 13px; color: var(--muted); }

    .industries { padding: 100px 0; }
    .ind-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 16px; }
    .ind-card { background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 14px; padding: 28px 20px; text-align: center; transition: transform .2s; }
    .ind-card:hover { transform: translateY(-3px); border-color: var(--primary); opacity: 0.3; }
    .ind-icon { font-size: 36px; margin-bottom: 12px; }
    .ind-name { font-family: var(--font-family, 'Inter', sans-serif); font-size: 13px; font-weight: 700; color: var(--white); }

    .pricing { padding: 100px 0; background: var(--bg2); }
    .price-toggle { display: flex; justify-content: center; gap: 0; margin-bottom: 64px; }
    .toggle-btn { padding: 12px 32px; font-size: 14px; font-weight: 700; border: 1px solid var(--border-color); cursor: pointer; transition: all .3s; font-family: var(--font-family, 'Inter', sans-serif); background: transparent; color: var(--muted); }
    .toggle-btn:first-child { border-radius: 8px 0 0 8px; }
    .toggle-btn:last-child { border-radius: 0 8px 8px 0; }
    .toggle-btn.active { background: var(--primary); color: var(--white); border-color: transparent; }
    .pricing-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 18px; }
    .price-card { background: var(--card-bg); border: 1px solid var(--border-color); backdrop-filter: blur(10px); border-radius: 22px; padding: 40px 30px; transition: transform .25s; }
    .price-card:hover { transform: translateY(-4px); }
    .price-card.popular { border-color: var(--primary); position: relative; }
    .pop-badge { display: inline-block; padding: 5px 14px; background: linear-gradient(90deg,var(--primary),var(--secondary)); border-radius: 20px; font-size: 11px; font-weight: 700; color: var(--white); margin-bottom: 14px; }
    .plan-name { font-family: var(--font-family, 'Inter', sans-serif); font-size: 13px; font-weight: 700; color: var(--muted); letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 8px; }
    .plan-price { font-family: var(--font-family, 'Inter', sans-serif); font-size: 38px; font-weight: 800; color: var(--white); margin-bottom: 4px; }
    .plan-price sup { font-size: 18px; vertical-align: super; }
    .plan-period { font-size: 13px; color: var(--muted); margin-bottom: 24px; }
    .plan-features { list-style: none; margin-bottom: 28px; }
    .plan-features li { font-size: 13px; color: var(--muted); padding: 7px 0; border-bottom: 1px solid var(--border-color); display: flex; align-items: center; gap: 8px; }
    .plan-features li::before { content: '✓'; color: var(--secondary); font-weight: 700; }
    .btn-plan { display: block; width: 100%; padding: 12px; border-radius: 10px; text-align: center; font-size: 13px; font-weight: 700; font-family: var(--font-family, 'Inter', sans-serif); transition: all .2s; border: 1px solid var(--border-color); color: var(--muted); }
    .btn-plan:hover { border-color: var(--primary); color: var(--white); }
    .btn-plan-primary { background: linear-gradient(135deg,var(--primary),var(--secondary)); border-color: transparent; color: var(--white); }
    .btn-plan-primary:hover { opacity: .88; }

    .testimonials { padding: 120px 0; }
    .test-grid { display: grid; grid-template-columns: repeat(2,1fr); gap: 20px; }
    .test-card { background: var(--card-bg); border: 1px solid var(--border-color); backdrop-filter: blur(10px); border-radius: 20px; padding: 32px; }
    ...
    .test-av { width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg,var(--primary),var(--secondary)); display: grid; place-items: center; font-weight: 800; color: var(--white); font-size: 16px; }
    .test-name { font-family: var(--font-family, 'Inter', sans-serif); font-size: 14px; font-weight: 700; color: var(--white); }
    ...
    .faq-item { background: var(--card-bg); border: 1px solid var(--border-color); backdrop-filter: blur(10px); border-radius: 14px; padding: 24px 22px; }
    .faq-q { font-family: var(--font-family, 'Inter', sans-serif); font-size: 15px; font-weight: 700; color: var(--white); margin-bottom: 10px; }
    .faq-a { font-size: 13px; color: var(--muted); line-height: 1.65; }

    .cta-band { padding: 80px 0; border-top: 1px solid var(--border-color); }
    ...
    #ai-widget { position: fixed; bottom: 32px; right: 32px; width: 360px; z-index: 200; }
    .widget-card { background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(24px); border: 1px solid var(--border-color); border-radius: 20px; overflow: hidden; }
    .widget-head { padding: 16px 20px; background: linear-gradient(90deg,var(--primary),var(--secondary)); font-family: var(--font-family, 'Inter', sans-serif); font-size: 14px; font-weight: 800; color: var(--white); display: flex; align-items: center; gap: 8px; }
    .widget-body { padding: 14px; }
    #aiPrompt { width: 100%; padding: 10px 12px; border-radius: 10px; background: var(--bg2); border: 1px solid var(--border-color); color: var(--text); font-size: 13px; resize: none; font-family: var(--font-family, 'Inter', sans-serif); }
    #aiPrompt:focus { outline: none; border-color: var(--primary); }
    .widget-btns { margin-top: 10px; display: flex; gap: 8px; }
    #aiAsk { flex: 1; padding: 9px; border-radius: 8px; background: linear-gradient(135deg,var(--primary),var(--secondary)); color: var(--white); font-size: 12px; font-weight: 700; border: none; cursor: pointer; font-family: var(--font-family, 'Inter', sans-serif); }
    #aiClear { padding: 9px 14px; border-radius: 8px; border: 1px solid var(--border-color); background: transparent; color: var(--muted); font-size: 12px; cursor: pointer; }

    footer { background: var(--bg2); padding: 60px 0 28px; border-top: 1px solid var(--border-color); }
    ...
    .footer-col h4 { font-family: var(--font-family, 'Inter', sans-serif); font-size: 13px; font-weight: 700; color: var(--white); margin-bottom: 16px; letter-spacing: 1px; text-transform: uppercase; }
    ...
    .footer-bottom { border-top: 1px solid var(--border-color); padding-top: 24px; display: flex; align-items: center; justify-content: space-between; font-size: 12px; color: var(--muted); }
    .social-links { display: flex; gap: 10px; }
    .social-link { width: 32px; height: 32px; border-radius: 8px; border: 1px solid var(--border-color); display: grid; place-items: center; font-size: 14px; transition: border-color .2s; }
    ...
    @media (max-width: 600px) {
      .features-grid, .pricing-grid, .ind-grid, .steps-grid { grid-template-columns: 1fr; }
      nav .btn-nav-ghost { display: none; }
      #ai-widget { width: calc(100% - 32px); }
    }
  </style>
</head>
<body>
  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      ...
      <div>
        <div class="hero-card">
          <div style="font-size:13px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:1px;margin-bottom:16px;">Today's Appointments</div>
          <div class="appt-item">
          ...
          <div class="stats-row">
            <div class="stat-box"><div class="stat-num">24</div><div class="stat-lbl">Today</div></div>
            <div class="stat-box"><div class="stat-num">98%</div><div class="stat-lbl">Show Rate</div></div>
            <div class="stat-box"><div class="stat-num">4.9</div><div class="stat-lbl">Rating</div></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="ai-widget">
    <div class="widget-card">
      ...
      <div class="widget-body">
        <textarea id="aiPrompt" rows="3" placeholder="Ask about bookings, features, or how {{ $brandName }} works..."></textarea>
    ...
    <div class="section-inner">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>{{ $theme['footer_text'] ?: 'A smart solution for appointment management.' }}</p>
        </div>
        <div class="footer-col"><h4>Quick Links</h4><ul><li><a href="/">Home</a></li><li><a href="#pricing">Pricing</a></li><li><a href="#contact">Contact</a></li></ul></div>
        <div class="footer-col"><h4>Policy</h4><ul><li><a href="#">Privacy Policy</a></li><li><a href="#">Terms of Service</a></li></ul></div>
        <div class="footer-col">
          <h4>Contact</h4>
          @if($theme['contact_address'])<div class="contact-item">📍 {{ $theme['contact_address'] }}</div>@endif
          @if($theme['contact_phone'])<div class="contact-item">📞 {{ $theme['contact_phone'] }}</div>@endif
          @if($theme['contact_email'])<div class="contact-item">✉️ {{ $theme['contact_email'] }}</div>@endif
        </div>
      </div>
      <div class="footer-bottom">
        <div>© {{ date('Y') }} {{ $brandName }}. All Rights Reserved.</div>
  ...
  <script>
    ...
    document.getElementById('aiAsk')?.addEventListener('click', async () => {
      ...
      btn.disabled = true;
      document.getElementById('aiAnswer').textContent = '⏳ Generating response…';
      try {
        const res = await fetch('/ai/respond', {
          method: 'POST',
